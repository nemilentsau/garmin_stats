...
def get_heart_rate_insights(
    ...
    return insights_uc.get_heart_rate_insights(date)
...
def get_heart_rate_analysis():
    ...
    return insights_uc.get_heart_rate_analysis()
...
def get_hr_distribution(
    ...
    return insights_uc.get_hr_distribution(date)
...
def get_stress_analysis():
    ...
    return insights_uc.get_stress_analysis()
...
def get_body_battery_analysis():
    ...
    return insights_uc.get_body_battery_analysis()
