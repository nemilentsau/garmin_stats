...
# CORS for frontend
# Override by setting BACKEND_CORS_ORIGINS to a comma-separated list of allowed origins.
# Example: BACKEND_CORS_ORIGINS=http://localhost:3000,http://localhost:5173
