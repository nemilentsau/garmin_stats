# 06 — Review (extended runs only)

Self-review walking each gate. Confidence may be **downgraded** here, never upgraded.

| Gate | Pass? | Notes |
| --- | --- | --- |
| Question | | concrete? date+metrics explicit? type declared? pre-registration present if hypothesis-test? |
| Data | | source named + snapshot pinned? coverage/missingness measured? nulls/zeros/impossibles addressed? filters scoped? |
...
## Conclusion
- **promote** | **do not promote** — <one sentence>
