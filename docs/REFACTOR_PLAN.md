...
- [x] Move day-directory and FIT file grouping helpers into `parser_files.py`.
- [x] Move Garmin timestamp parsing, compressed timestamp resolution, UTC-offset extraction, and local-time shifting into `parser_timestamps.py`.
...
- [x] Keep `parser.py` as the public compatibility facade for existing imports.
