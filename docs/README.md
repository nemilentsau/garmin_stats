...
This directory contains current project documentation only. Historical implementation
plans are intentionally not kept as a parallel source of truth.
...
- [DATA_SCHEMA_DESIGN.md](/Users/andreinemilentsau/Projects/garmin_stats/docs/DATA_SCHEMA_DESIGN.md)
  Routine, card, schedule, Today, and live runtime storage semantics.

- [ROUTINE_ARTIFACT_BUNDLE_SPEC.md](/Users/andreinemilentsau/Projects/garmin_stats/docs/ROUTINE_ARTIFACT_BUNDLE_SPEC.md)
  Canonical bundle JSON contract for routine import.
...
- [backlog.md](/Users/andreinemilentsau/Projects/garmin_stats/docs/backlog.md)
  Active parked work only.

- [checkin-todo.md](/Users/andreinemilentsau/Projects/garmin_stats/docs/checkin-todo.md)
  Planned Daily Check-In UI and semantics.
...
- [morning_stretching_bundle.json](/Users/andreinemilentsau/Projects/garmin_stats/docs/morning_stretching_bundle.json)
