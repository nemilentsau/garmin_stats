...
- `insights.py` is a transitional landing zone for heavier analysis endpoints. It may start broad while absorbing existing services, but it should split into clearer families as the domain grows.
